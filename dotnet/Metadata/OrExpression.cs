...
namespace Compiler.Metadata
{
    public class OrExpression : Expression
    {
        ...
        public OrExpression(ILocation location, Expression left, Expression right)
            : base(location)
        {
            this.left = left;
            this.right = right;
        ...
        {
            return new OrExpression(this, left.InstantiateTemplate(parameters), right.InstantiateTemplate(parameters));
        }
    }
}
