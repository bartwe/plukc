...
namespace Compiler.Binary.LinuxELF64X86_64
{
    public class Generator : Compiler.Generator, IDisposable
    {
            ...
            : base(paths, ignoreFileCase)
        {
            ...
            sections = new Sections(stringTable, true);
        ...
        {
            linker = new Linker(moduleName, sections, stringTable, true);
        }
        ...
        {
            return new AssemblerX86_64(sections.GetSection(".text").AllocateRegion());
        }
