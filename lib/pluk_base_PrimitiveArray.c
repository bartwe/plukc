...
pref pluk_base_PrimitiveArray__Alloc(pref this, pref count, pref initialValue)
{
  pref result;
  pref* slot;
  int i;
...
pref pluk_base_PrimitiveArray__InnerOperatorSetIndex(pref this, pref index, pref value)
{
  pref result;
  pref* slot;
  result.value = 0;
...
pref pluk_base_PrimitiveArray__InnerOperatorGetIndex(pref this, pref index)
{
  pref* slot;
  slot = &((pref*)(this.value[0]))[longFromPref(index)];
  return slot[0];
...
pref pluk_base_PrimitiveArray__pluk_base_Bool__Alloc(pref this, pref count, pref initialValue)
{
  pref result;
  signed char* slot;
  result.value = 0;
...
pref pluk_base_PrimitiveArray__pluk_base_Bool__InnerOperatorSetIndex(pref this, pref index, pref value)
{
  pref result;
  result.value = 0;
  result.type = 0;
...
pref pluk_base_PrimitiveArray__pluk_base_Bool__InnerOperatorGetIndex(pref this, pref index)
{
  pref result;
...
pref pluk_base_PrimitiveArray__pluk_base_Byte__Alloc(pref this, pref count, pref initialValue)
{
  pref result;
  unsigned char* slot;
  result.value = 0;
...
pref pluk_base_PrimitiveArray__pluk_base_Byte__InnerOperatorSetIndex(pref this, pref index, pref value)
{
  pref result;
  result.value = 0;
  result.type = 0;
...
pref pluk_base_PrimitiveArray__pluk_base_Byte__InnerOperatorGetIndex(pref this, pref index)
{
  pref result;
...
pref pluk_base_PrimitiveArray__pluk_base_Int__Alloc(pref this, pref count, pref initialValue)
{
  pref result;
  long* slot;
  long initial;
...
pref pluk_base_PrimitiveArray__pluk_base_Int__InnerOperatorSetIndex(pref this, pref index, pref value)
{
  pref result;
  result.value = 0;
  result.type = 0;
...
pref pluk_base_PrimitiveArray__pluk_base_Int__InnerOperatorGetIndex(pref this, pref index)
{
  pref result;
